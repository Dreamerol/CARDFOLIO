...
<h2>𝗗𝗿𝗮𝘄𝗻 𝘁𝗼 𝘂𝗻𝗱𝗲𝗿𝘀𝘁𝗮𝗻𝗱𝗶𝗻𝗴 𝗵𝗼𝘄 𝘀𝘆𝘀𝘁𝗲𝗺𝘀 𝘄𝗼𝗿𝗸 𝗯𝗲𝗻𝗲𝗮𝘁𝗵 𝘁𝗵𝗲 𝘀𝘂𝗿𝗳𝗮𝗰𝗲 — 𝗻𝗼𝘁 𝗷𝘂𝘀𝘁 𝘂𝘀𝗶𝗻𝗴 𝘁𝗵𝗲𝗺, 𝗯𝘂𝘁 𝗳𝗲𝗲𝗹𝗶𝗻𝗴 𝗵𝗼𝘄 𝘁𝗵𝗲𝘆 𝗳𝗶𝘁 𝘁𝗼𝗴𝗲𝘁𝗵𝗲𝗿. Over time, this curiosity became a steady craft — quietly shaping abstract problems into simple, working solutions where logic and structure do the heavy lifting, almost in silence.

<hr>

Outside of coding, there is focus on calm consistency, discipline, and continuous improvement. The current path is Software Engineering, with strong interest in systems, algorithms, and machine learning. </a> </h2> </div>
